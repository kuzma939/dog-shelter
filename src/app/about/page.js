...
const TEAM = [
  { id: "anna",  name: "Кузьма Ганна",        role: "Lead full-stack developer", photo: "/image/about/anja.jpg" },
  { id: "diana", name: "Горбик Діана",        role: "Lead UX/UI designer",       photo: "/image/about/diana.jpg" },
  { id: "olex",  name: "Озирський Олексій",   role: "Full-stack developer",      photo: "/image/about/oleksij.jpg" },
  { id: "olja",  name: "Трембіцька Ольга",    role: "UX/UI designer",            photo: "/image/about/olja.jpg" },
];
...
export default function AboutPage() {
  ...
  <ul className={css.partnerList}>
    {PARTNERS.map(p => (
      <li key={p.id} className={css.partnerItem}>
        <Image src={p.src} alt={p.alt} width={180} height={60} />
      </li>
    ))}
  </ul>
</section>
      ...
      <section id="mission" className={css.section}>
        ...
        <p className={css.text}>
          ...
          життя в сім’ях. Наша мета — менше тварин на вулицях і більше любові
          та відповідальності в людях.
        </p>
      </section>
      ...
      <section id="values" className={css.section}>
        ...
        <ul className={css.values}>
          ...
          <li>Відповідальність — дбаємо про тварин і закликаємо людей робити так само.</li>
          <li>Прозорість — відкрито показуємо, куди йдуть ресурси.</li>
          <li>Спільнота — разом із волонтерами й небайдужими творимо сім’ю добра.</li>
          <li>Надія — віримо, що навіть травмовані собаки знову знайдуть довіру й щастя.</li>
        </ul>
      </section>
      ...
      <section id="gratitude" className={css.section}>
        ...
        <p className={css.text}>
          ...
          собак до себе, хто підтримує нас фінансово чи ділиться інформацією
          про наших хвостиків. Ваша небайдужість рятує життя. Завдяки вам наші
